    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (decodedData is Map<String, dynamic>) {
          ...
          final QuestionnaireResult questionnaire =
          QuestionnaireResult.fromJson(decodedData);
          return [questionnaire];
        } else if (decodedData is List) {
          // Si decodedData es una lista, asumimos que son múltiples cuestionarios
          final List<QuestionnaireResult> questionnaires = decodedData
              .map((entry) => QuestionnaireResult.fromJson(entry))
              .toList();
